...
public struct ExceptionParam(Exception exception)
{
    ...
    internal static readonly List<int> s_searchApiHResults = [MSS_E_CATALOGNOTFOUND, OLEDB_BINDER_CUSTOM_ERROR, GTHR_E_SINGLE_THREADED_EMBEDDING];
